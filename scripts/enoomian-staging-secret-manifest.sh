...
ENOOMIAN_PERSONAL_SECRET_OPTIONAL_KEYS=(
  ...
  ENOOMIAN_AWS_GPU_HOST
  ENOOMIAN_AWS_GPU_SSH_USER
  ENOOMIAN_AWS_GPU_SSH_KEY
  ENOOMIAN_AWS_GPU_SSH_PORT
  ENOOMIAN_AWS_GPU_REMOTE_ROOT
  ENOOMIAN_AWS_GPU_API_PORT
  ENOOMIAN_AWS_GPU_UWS_PORT
  ENOOMIAN_AWS_GPU_DATABASE_URL
  ENOOMIAN_AWS_GPU_START_SOURCE
  ENOOMIAN_AWS_GPU_STREAM_DELIVERY_MODE
  ENOOMIAN_AWS_GPU_STREAM_DELIVERY_PROVIDER
  ENOOMIAN_AWS_GPU_STREAM_ENABLED_DESTINATIONS
  ENOOMIAN_AWS_GPU_STREAM_CANONICAL_PROVIDER_PRIORITY
  ENOOMIAN_AWS_GPU_PUBLIC_HLS_URL
  ENOOMIAN_AWS_GPU_PUBLIC_LLHLS_URL
  ENOOMIAN_AWS_GPU_PUBLIC_API_URL
  ENOOMIAN_AWS_GPU_PUBLIC_WS_URL
  ENOOMIAN_AWS_GPU_ACTIVATE_PUBLIC_AUTHORITY
  ENOOMIAN_AWS_GPU_SYNC_HYPERSCAPES_RAILWAY_ENV
  ENOOMIAN_AWS_GPU_SYNC_HYPERBET_KEEPER_ENV
)
