...
export type DuelMarket = {
  ...
  instructions: [
    ...
    {
      name: "continueOrder";
      discriminator: [52, 137, 158, 152, 162, 246, 203, 104];
      accounts: [
        {
          name: "marketState";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [30, 68, 20, 154, 197, 42, 47, 122];
      accounts: [
        {
          name: "authority";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [233, 31, 161, 248, 178, 111, 102, 65];
      accounts: [
        {
          name: "authority";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [235, 180, 137, 53, 242, 12, 85, 213];
      accounts: [
        {
          name: "marketState";
          writable: true;
  ...
  accounts: [
    ...
    {
      name: "priceLevel";
      discriminator: [236, 106, 90, 162, 188, 41, 219, 186];
    },
    {
      name: "userBalance";
  ...
  events: [
    ...
    {
      name: "marketSynced";
      discriminator: [12, 197, 233, 97, 244, 67, 27, 33];
    },
    {
      name: "orderCancelled";
    ...
    {
      name: "orderMatched";
      discriminator: [211, 0, 178, 174, 61, 245, 45, 250];
    },
    {
      name: "orderPlaced";
      discriminator: [96, 130, 204, 234, 169, 219, 216, 227];
    },
    {
      name: "selfTradePolicyTriggered";
      discriminator: [83, 88, 117, 16, 191, 232, 1, 86];
    },
  ];
  errors: [
    {
