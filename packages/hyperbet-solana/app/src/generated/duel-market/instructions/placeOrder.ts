...
export type ParsedPlaceOrderInstruction<TProgram extends string = typeof DUEL_MARKET_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
