...
export function getContinueOrderInstruction<TAccountMarketState extends string, TAccountDuelState extends string, TAccountUserBalance extends string, TAccountOrder extends string, TAccountRestingLevel extends string, TAccountConfig extends string, TAccountTreasury extends string, TAccountMarketMaker extends string, TAccountVault extends string, TAccountUser extends string, TAccountSystemProgram extends string, TProgramAddress extends Address = typeof DUEL_MARKET_PROGRAM_ADDRESS>(input: ContinueOrderInput<TAccountMarketState, TAccountDuelState, TAccountUserBalance, TAccountOrder, TAccountRestingLevel, TAccountConfig, TAccountTreasury, TAccountMarketMaker, TAccountVault, TAccountUser, TAccountSystemProgram>, config?: { programAddress?: TProgramAddress } ): ContinueOrderInstruction<TProgramAddress, TAccountMarketState, TAccountDuelState, TAccountUserBalance, TAccountOrder, TAccountRestingLevel, TAccountConfig, TAccountTreasury, TAccountMarketMaker, TAccountVault, TAccountUser, TAccountSystemProgram> {
  // Program address.
const programAddress = config?.programAddress ?? DUEL_MARKET_PROGRAM_ADDRESS;
...
export type ParsedContinueOrderInstruction<TProgram extends string = typeof DUEL_MARKET_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
