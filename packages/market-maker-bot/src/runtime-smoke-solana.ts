...
import lvrMarketIdl from "../../hyperbet-solana/anchor/target/idl/lvr_amm.json" with { type: "json" };
import {
  airdrop,
...
async function main() {
  ...
  process.env.LVR_AMM_PROGRAM_ID = clobProgram.programId.toBase58();
